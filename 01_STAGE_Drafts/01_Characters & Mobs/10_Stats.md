# Stats
The PC has a number of stats: 
## Main Stats and Progression
Your main stats go from **1 to 5**. Level 1 is the starting value. Increasing a stat not only adds more dice to tests involving that stat, but it also provides hard mechanical upgrades to your Boss's capabilities. 

### Tough (T)
*Used for violence, intimidation, and lifting stuff.*
Tough determines your **Grit** (Health) and **Carry Capacity** (how much Bulk you can carry). 
*   **Level 1 (Starting):** 3 Grit. Carry Capacity 6.
*   **Level 2:** **4 Grit.** Carry Capacity 8.
*   **Level 3:** 4 Grit. Carry Capacity 10.
*   **Level 4:** **5 Grit.** Carry Capacity 12.
*   **Level 5 (Max):** 5 Grit. Carry Capacity 14.
...
Mouth determines how many Mobs you can command and gives you **Free Orders** that do not cost your standard actions. 
*   **Level 1 (Starting):** Max 1 Mob. 1 Free Order per round.
*   **Level 2:** **Max 2 Mobs.** 1 Free Order per round.
*   **Level 3:** Max 2 Mobs. **2 Free Orders per round.**
*   **Level 4:** **Max 3 Mobs.** 2 Free Orders per round.
...
* **Grit:** Your health. You die when this reaches 0. Determined by your **Tough** track.
* **Carry:** How much Bulk (Loot/Equipment) you can carry. Determined by your **Tough** track. See [[Loot]] for more info.
* **Movement:** How many Zones you can cross with a Move action. Determined by your **Slink** track.
* **Grunt:** Your authority and energy. **Grunt is equal to your second highest stat.** Your Grunt determines the maximum Size of a Mob you can command (e.g., Grunt 3 means you can command a maximum Size 3 Mob. If you merge a Mob larger than your Grunt, it becomes Uncontrolled).
...
However, Goblins huddle close and do not really care about other in another group. So if you have enough Grunt, you can command several mobs of the same size, but if the group feel you are not important enough, they will not care whatever you say and the risk of some big shot thinking he could do this better than you is suddenly very high. To assert your dominance should now be your top priority! 
