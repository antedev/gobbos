...
## Dice & Tests
*   **Difficulty:** The die face needed to score a "success" (Easy: 4-6, Normal: 5-6, Hard: 6).
*   **Target Number (TN):** The total number of successes required to pass a test. (e.g., Normal:1 means you need one die to land on 5 or 6).
...
## Combat & Movement
*   **Zone:** An abstract area of the battlefield (a room, a corridor) used to measure movement and range.
