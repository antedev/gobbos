-- 
Design goal: Create Gangs that are fun to play, and that give some mechanical benefits to the players. They can to some extent be used in the same way as a Class can be used in a D&D game, but they are not as rigid. And to truly level, your goblins need to die or retire. That unlocks the next generation of goblins, and the cycle continues.
--
...
# Renown 
Renown represents how feared and respected your specific group of gobbos is within the larger Lair. Mechanically it is a tool to use when you create your next Goblin Boss, 
