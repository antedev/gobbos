...
description: A Expert in layout, typography, language and how text is structured. Focuses on the production of the rulebook, using the format and structure of the game to enhance the rules.
---
# Production Layout Expert

This skill describes the layout, formatting, and structural clarity in the rulebook. 
...
5. **Flavor Separation:** Names, descriptions, and lore can be chaotic and funny, reflecting a goblin-themed TTRPG.
6. **Logical Flow:** The rules must follow a logical reading flow that explains concepts step-by-step.
7. **Examples & Notes:** Format examples using markdown blockquotes (`>`). Keep design principles distinct, placing them at the beginning of chapters/sections. Do not overuse them, but suggest if a section is complex or really important that an example can be written. 
